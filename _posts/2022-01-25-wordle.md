...
Then, make sure that 'GitHub Pages' (th free service we are using to host your website) is set up to deploy from your 'gh-pages' branch. You can do this by going to Settings > Pages and then selecting "Branch: gh-pages" as the source as shown below:
